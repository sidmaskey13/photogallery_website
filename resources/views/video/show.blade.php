        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <div class="btn-group">
                    ...
                    <form id="delete-video_{{$show_video->id}}" action="{{route('video.destroy',$show_video->id)}}" method="post">
                        {{csrf_field()}}
                        {{method_field('delete')}}
