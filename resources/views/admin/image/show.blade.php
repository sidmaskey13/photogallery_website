...
@section('content')
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="{{url('/add-image') }}">Images</a></li>
            <li>{{$media->title}}</li>
        </ul>
        <div class="row">
        ...
        <div class="detail-container">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="btn-group">
                        <a href="{{url('add-image/'.$media->id.'/edit')}}" class="btn btn-success">Edit</a>
                        <form id="delete-media_{{$media->id}}" action="{{url('add-image/'.$media->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field('delete')}}
