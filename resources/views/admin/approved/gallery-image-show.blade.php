...
@section('content')
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="{{url('/approved-image') }}">Approved Image</a></li>
            <li>{{$media->title}}</li>
        </ul>
        <div class="row">
        ...
        <div class="detail-container">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    @foreach($media->category_media as $c)
                ...
                <div class="col-4">
                    ...
                    <div class="btn-group">
                        <a href="{{url('edit-image/'.$media->id)}}" class="btn btn-primary">Edit</a>
                        <form id="delete-media_{{$media->id}}" action="{{URL::to('/approved-image/'.$media->id)}}" method="post">
                            {{csrf_field()}}
                            {{method_field('delete')}}
