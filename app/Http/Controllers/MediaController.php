...
class MediaController extends Controller
{
    ...
    {
        $this->middleware('permission:photos-uploader');
    }
    ...
    {
        $medias = Media::where('user_id',Auth::user()->id )->orderBy('id','DESC')->paginate(12);
    ...
    public function create()
    {
        ...
        return view('media.create',compact('category','tag','license_modify','license_usage'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $notification->remarks="Image Album added by Uploader ".$user->name;
        $notification->save();
...
//            $license_mod=$media->license;
    ...
    public function edit($id)
    {
        ...
        $license_usage=License::where('type',2)->get();
        $tags=Tag::all();
        return view('media.edit',compact('edit_media','categories','tags','license_modify','license_usage'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $notification->user_id=$user->id;
        $notification->user_type=1;
        $notification->remarks="Image Album updated by Uploader ".$user->name;
        $notification->save();

            Session::flash('success', 'Media Edited');
    ...
    public function destroy($id)
    {
        ...
        $notification->user_id=$user->id;
        $notification->user_type=1;
        $notification->remarks="Image Album deleted by Uploader ".$user->name;
        $notification->save();
